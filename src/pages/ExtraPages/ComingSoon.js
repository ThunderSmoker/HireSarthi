        ...
        <React.Fragment>
            <div>
                <div className="main-content">
                        ...
                        <MetaTags>
                            <title>Coming Soon | HireSarthi - Job Listing Template | Themesdesign</title>
                        </MetaTags>                          
                                    ...
                                    <Row className="justify-content-center">
                                        <Col lg={6}>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted mb-4 pb-3">Start working with HireSarthi that can provide everything you need to generate awareness, drive traffic, connect.</p>
